...
import com.sendbird.android.sample.Game.Clue;
import com.sendbird.android.sample.Game.Found;
import com.sendbird.android.sample.Game.MSButton;
import com.sendbird.android.sample.Game.Waiting;
...
public class GroupChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FloatingActionButton foundB=new FloatingActionButton(getContext());
        foundB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MSButton button= new MSButton("48:1A:84:00:14:A1");
                IMultiSenseAtom atom=button.getAtom();
                Intent intent = new Intent(getActivity(),MSButton.class);
